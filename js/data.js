...
window.CLASSES = [
    ...
    { name: "THE DOOMREADER", desc: "Up to once per turn, you may discard 1 card to The Dark to exile one ghost from your Shadow to The Dark (no Banish check; no Siphon)." },
    { name: "THE EXORCIST", desc: "Your 7 (Cleanse) banishes 2 Ghosts from your Shadow. You may Siphon only one (to the bottom of your Candle); the other goes to the top of The Dark." },
    ...
    { name: "THE GRIMOIRE OF REJECTION", desc: "As your action, write down a card name and keep it hidden. You may reveal it whenever you want to cancel any player's play of that card. The cancel cannot be interrupted by Salt. You cannot change the written name until it has been consumed (activated); then you may write a new one as an action on a later turn." },
    ...
    { name: "THE USERER", desc: "As your action, choose a neighbour; take 2 cards from their hand, then they Draw 1 from their Candle." },
