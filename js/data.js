...
window.CLASSES = [
    ...
    { name: "THE GRIMOIRE OF REJECTION", desc: "Ability (not your Ritual action): Secretly write a card name. Reveal anytime to cancel any player's play of it, cannot be Salted. Locked until it triggers, then write anew. Same name cannot follow itself (Ace, 5, Ace is fine)." },
